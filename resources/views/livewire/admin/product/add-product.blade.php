        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <div class="text-muted mt-1">Create a new product with variants or simple product</div>
                </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" wire:model.live="has_variants" id="hasVariants">
                                    <label class="form-check-label" for="hasVariants">
                                        This product has multiple variants (e.g., different sizes, colors)
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                @if (count($variants) > 0)
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header">
                                            <h4 class="card-title">Variant #{{ $index + 1 }}</h4>
                                            <div class="card-actions">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <small class="form-hint">You can upload multiple images. First image will be set as primary.</small>
