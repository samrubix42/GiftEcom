            ...
            <table class="table table-vcenter card-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            @if($cat->image)
                                <img src="{{ asset('storage/'.$cat->image) }}" width="50" class="rounded">
                            @else
                                —
                            @endif
                        </td>
                        ...
                        <td>
                            @if($cat->is_featured)
                                <span class="badge bg-info-lt">Yes</span>
                            @else
                    ...
                    <tr class="table-row-muted">
                        <td>
                            @if($child->image)
                                <img src="{{ asset('storage/'.$child->image) }}" width="50" class="rounded">
                            @else
                                —
                            @endif
                        </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        @elseif($imagePreview)
                            <img src="{{ $imagePreview }}" class="img-thumbnail mt-2" style="max-width:150px;">
                        @endif
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">
                        You are about to delete <strong>{{ $deleteName }}</strong>. This action cannot be undone.
                    </div>
                </div>

                <div class="modal-footer">
                    <div class="w-100 d-flex justify-content-end gap-2">
                        <button class="btn btn-link link-secondary" wire:click="$set('confirmDelete', false)">Cancel</button>
