                            ...
                            <li class="grid-item">
                                <div class="category-box bg-dark-gray">
                                    ...
                                    <div class="category-hover-content d-flex flex-column align-items-center justify-content-center bg-base-color p-40px lg-p-25px">
                                        ...
                                        <a class="fs-14 fw-500 text-dark-gray text-uppercase position-absolute z-index-1 bottom-25px ls-05px" href="{{ route('shop', ['category' => $category->slug]) }}">View collection</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end shop item -->
