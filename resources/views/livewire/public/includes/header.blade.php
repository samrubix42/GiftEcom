                                        ...
                                        <div class="mega-menu m-auto">
                                            <div class="row md-m-0">
                                                <div class="col-12 col-lg-9">
                                                    <div class="row row-cols-1 row-cols-lg-4 align-items-center justify-content-center">
                                                        <div class="col mb-20px md-mb-10px text-start text-lg-center">
                                                            ...
                                                            <a href="demo-jewellery-store-categories.html" class="btn btn-hover-animation fw-500 text-uppercase-inherit justify-content-center pt-0 pb-0 text-start text-lg-center">
                                                                <span> 
                                                ...
                                                <div class="col-lg-3 col-md-4 d-none d-lg-flex">
                                                    <div>
                                                        <a href="demo-jewellery-store-categories.html"><img src="https://placehold.co/290x380" class="border-radius-4px" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
